...
var table1,thead1,tbody1,row1,row2,row3;
function CreateInit(){
            ...
            row3=tbody1.append('tr').attr("class", "valColumn");
            // append the header row
            thead1.append('tr')
                  .selectAll('th')
                  .data(data.attrs)
